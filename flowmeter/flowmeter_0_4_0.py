class Flowmeter:
    ...
    def get_total_len_forward_packets(self, src_df):
        ...
        """
        return src_df["size"].values.sum()
        
    
    def get_total_len_backward_packets(self, dst_df):
        ...
        return dst_df["size"].values.sum()
    
    def get_total_forward_packets(self, src_df):
        ...
        return  src_df.shape[0]

    
    def get_total_backward_packets(self, dst_df):
        ...
        return  dst_df.shape[0]

    def get_min_forward_packet_size(self, src_df):
    ...
    def get_min_backward_packet_size(self, dst_df):
        ...
        if self.multicast_flag == 1:
            ...
            return  min(dst_df["size"])

    def get_max_forward_packet_size(self, src_df):
    ...
    def get_max_backward_packet_size(self, dst_df):
        ...
        if self.multicast_flag == 1:
            ...
            return  max(dst_df["size"])

    def get_mean_forward_packet_size(self, src_df):
    ...
    def get_mean_backward_packet_size(self, dst_df):
        ...
        return  dst_df["size"].mean()
    
    def get_std_forward_packet_size(self, src_df):
    ...
    def get_std_backward_packet_size(self, dst_df):
        ...
        return  dst_df["size"].std()

    def get_iat_forward_total_time(self, src_df):
    ...
    def get_iat_backward_total_time(self, dst_df):
        ...
        return  dst_df["time"].diff().sum() 

    def get_src_times(self, df, src):
    ...
    def get_dst_times(self, df, dst):
        ...
        dst_df = df.loc[df["src"]==dst]
        return  dst_df["time"]

    def get_iat_forward_min_times(self, df, src):
    ...
    def get_iat_backwards_min_times(self, df, dst):
        ...
        dst_times = self.get_dst_times(df, dst)
        if self.multicast_flag == 1 or dst_times.shape[0] == 1:
            return 0 # Test
        else:
            return  min(dst_times.diff().dropna().tolist()) 

    def get_iat_forward_max_times(self, df, src):
    ...
    def get_iat_backwards_max_times(self, df, dst):
        ...
        dst_times = self.get_dst_times(df, dst)
        if dst_times.shape[0] < 2:
            return 0
        else:
            return  max(dst_times.diff().dropna()) 

    def get_iat_forward_mean_times(self, df, src):
    ...
    def get_iat_backwards_mean_times(self, df, dst):
        ...
        dst_times = self.get_dst_times(df, dst)
        return  dst_times.diff().dropna().mean() 

    def get_iat_forward_std_times(self, df, src):
    ...
    def get_iat_backwards_std_times(self, df, dst):
        ...
        dst_times = self.get_dst_times(df, dst)
        return  dst_times.diff().dropna().std() 
    ...
    def get_total_forward_push_flags(self, df, src):
    ...
    def get_total_backward_push_flags(self, df, dst):
        ...
        return self.count_flags(df, dst, "P")

    def get_total_forward_urgent_flags(self, df, src):
    ...
    def get_total_backward_urgent_flags(self, df, dst):
        ...
        return self.count_flags(df, dst, "U")

    def get_total_header_len_forward_packets(self, src_df):
        ...
        return src_df["size"].values.sum() - self.get_total_len_forward_packets(src_df)

    def get_total_header_len_backward_packets(self, dst_df):
        ...
        if self.multicast_flag == 1:
            ...
            return dst_df["size"].values.sum() - self.get_total_len_backward_packets(dst_df)

    def get_forward_packets_per_second(self, df, src_df):
        ...
        """
        if df.shape[0] > 1:
            return self.get_total_forward_packets(src_df) / self.get_flow_duration(df)
        else:
             return 1

    def get_backward_packets_per_second(self, df, dst_df):
        ...
        if df.shape[0] > 1:
            return self.get_total_backward_packets(dst_df) / self.get_flow_duration(df) 
        else:
             return 1

    def get_flow_packets_per_second(self, df, src_df, dst_df):
        ...
        """
        if df.shape[0] > 1:
            return (self.get_total_backward_packets(dst_df) + self.get_total_forward_packets(src_df)) / self.get_flow_duration(df)
        else:
            return 1

    def get_flow_bytes_per_second(self, df, src_df, dst_df):
        ...
        return (self.get_total_len_forward_packets(src_df) + self.get_total_len_backward_packets(dst_df)) / self.get_flow_duration(df)
    ...
    def get_total_flow_push_flags(self, df, src, dst):
    ...
    def get_total_flow_fin_flags(self, df, src, dst):
    ...
    def get_total_flow_syn_flags(self, df, src, dst):
    ...
    def get_total_flow_reset_flags(self, df, src, dst):
    ...
    def get_total_flow_ack_flags(self, df, src, dst):
    ...
    def get_total_flow_urg_flags(self, df, src, dst):
    ...
    def get_total_flow_cwr_flags(self, df, src, dst):
    ...
    def get_total_flow_ece_flags(self, df, src, dst):
    ...
    def get_average_forward_bytes_per_burt(self, src_df, window=100):
    ...
    def get_average_backward_bytes_per_burt(self, dst_df, window=100):
        ...
        dst_burst_rate = self.get_average_burst_rate(dst_df)
        dst_bytes = self.get_total_len_backward_packets(dst_df)
        if self.multicast_flag == 1:
            return 0
        else:
            return dst_bytes / dst_burst_rate

    def get_upload_download_ratio(self, src_df, dst_df):
        ...
        if self.multicast_flag == 1:
            ...
            return self.get_total_len_forward_packets(src_df) / self.get_total_len_backward_packets(dst_df)
    ...
    def get_avg_forward_segment_size(self, src_df):
    ...
    def get_avg_backward_segment_size(self, dst_df):
        ...
        return dst_df["payload"].mean()

    def get_avg_forward_burst_packets(self, src_df):
    ...
    def get_avg_backward_burst_packets(self, dst_df):
        ...
        return self.get_average_burst_rate(dst_df)

    def get_avg_forward_in_total_burst(self, df, src_df):
    ...
    def get_avg_backward_in_total_burst(self, df, dst_df):
        ...
        return self.get_average_burst_rate(dst_df) / self.get_average_burst_rate(df)
    ...
    def build_index(self, df, src, dst):
    ...
    def _build_feature_from_flow(self, flow):
        ...
        if flow == "Other" or "Ethernet" in flow or "ARP" in flow: 
            ...
            result["flow"] = [self.build_index(flow, src, dst)]
            ...
            result["total_fpackets"] = [self.get_total_forward_packets(src_df)]
            result["total_bpackets"] = [self.get_total_backward_packets(dst_df)]
            result["total_fpktl"] = [self.get_total_len_forward_packets(src_df)]
            result["total_bpktl"] = [self.get_total_len_backward_packets(dst_df)]
            result["min_fpktl"] = [self.get_min_forward_packet_size(src_df)]
            result["min_bpktl"] = [self.get_min_backward_packet_size(dst_df)]
            result["max_fpktl"] = [self.get_max_forward_packet_size(src_df)]
            result["max_bpktl"] = [self.get_max_backward_packet_size(dst_df)]
            result["mean_fpktl"] = [self.get_mean_forward_packet_size(src_df)]
            result["mean_bpktl"] = [self.get_mean_backward_packet_size(dst_df)]
            result["std_fpktl"] = [self.get_std_forward_packet_size(src_df)]
            result["std_bpktl"] = [self.get_std_backward_packet_size(dst_df)]
            result["total_fiat"] = [self.get_iat_forward_total_time(src_df)]
            result["total_biat"] = [self.get_iat_backward_total_time(dst_df)]
            result["min_fiat"] = [self.get_iat_forward_min_times(flow, src)]
            result["min_biat"] = [self.get_iat_backwards_min_times(flow, dst)]
            result["max_fiat"] = [self.get_iat_forward_max_times(flow, src)]
            result["max_biat"] = [self.get_iat_backwards_max_times(flow, dst)]
            result["mean_fiat"] = [self.get_iat_forward_mean_times(flow, src)]
            result["mean_biat"] = [self.get_iat_backwards_mean_times(flow, dst)]
            result["std_fiat"] = [self.get_iat_forward_std_times(flow, src)]
            result["std_biat"] = [self.get_iat_backwards_std_times(flow, dst)]
            result["fpsh_cnt"] = [self.get_total_forward_push_flags(flow, src)]
            result["bpsh_cnt"] = [self.get_total_backward_push_flags(flow, dst)]
            result["furg_cnt"] = [self.get_total_forward_urgent_flags(flow, src)]
            result["burg_cnt"] = [self.get_total_backward_urgent_flags(flow, dst)]
            result["total_fhlen"] = [self.get_total_header_len_forward_packets(src_df)]
            result["total_bhlen"] = [self.get_total_header_len_backward_packets(dst_df)]
            result["fPktsPerSecond"] = [self.get_forward_packets_per_second(flow, src_df)]
            result["bPktsPerSecond"] = [self.get_backward_packets_per_second(flow, dst_df)]
            result["flowPktsPerSecond"] = [self.get_flow_packets_per_second(flow, src_df, dst_df)]
            result["flowBytesPerSecond"] = [self.get_flow_bytes_per_second(flow, src_df, dst_df)]
            ...
            result["flow_fin"] = [self.get_total_flow_fin_flags(flow, src, dst)]
            result["flow_syn"] = [self.get_total_flow_syn_flags(flow, src, dst)]
            result["flow_rst"] = [self.get_total_flow_reset_flags(flow, src, dst)]
            result["flow_psh"] = [self.get_total_flow_push_flags(flow, src, dst)]
            result["flow_ack"] = [self.get_total_flow_ack_flags(flow, src, dst)]
            ...
            result["fAvgPacketsPerBulk"] = [self.get_avg_forward_burst_packets(src_df)]
            result["fAvgBulkRate"] = [self.get_avg_forward_in_total_burst(flow, src_df)]
            result["bAvgSegmentSize"] = [self.get_avg_backward_segment_size(dst_df)]
            result["bAvgBytesPerBulk"] = [self.get_average_backward_bytes_per_burt(dst_df)]
            result["bAvgPacketsPerBulk"] = [self.get_avg_backward_burst_packets(dst_df)]
            result["bAvgBulkRate"] = [self.get_avg_backward_in_total_burst(flow, dst_df)]
            result["label"] = ["None"]
            #print(("\nAppending {}\n").format(result))
            return result
            #print(self._frames)
